  ...
  return (
    <>
      ...
      <section className={styles.heroSection}>
        <Image
          src="/assets/background-service.png"
          alt="Azam Auto Services"
          fill
        ...
        <div className={`container ${styles.heroInner}`}>
          ...
          <div className={styles.heroMeta}>
            <div className={styles.heroMetaItem}>
              ...
              <span className={styles.heroMetaLabel}>{lang === 'en' ? 'Service Types' : 'Jenis Servis'}</span>
            </div>
            <div className={styles.heroMetaDivider} />
            <div className={styles.heroMetaItem}>
              <span className={styles.heroMetaNum}>70+</span>
              <span className={styles.heroMetaLabel}>{lang === 'en' ? 'Technicians' : 'Juruteknik'}</span>
            </div>
            <div className={styles.heroMetaDivider} />
            <div className={styles.heroMetaItem}>
              <span className={styles.heroMetaNum}>5+</span>
        ...
        <div className="container">
          ...
          <div className={styles.listHeader}>
            ...
            <h2 className={styles.listTitle}>
              {lang === 'en' ? 'Explore Our Services' : 'Terokai Perkhidmatan Kami'}
            </h2>
          </div>
          ...
          <div className={styles.ctaLeft}>
            ...
            <h2 className={styles.ctaTitle}>
              {lang === 'en'
                ...
                : "Tidak pasti servis\nmana yang anda perlukan?"}
            </h2>
          </div>
          <div className={styles.ctaRight}>
            <p className={styles.ctaText}>
              {lang === 'en'
                ? "Talk to our team and we'll diagnose your vehicle and recommend the right service for you."
                : "Bercakap dengan pasukan kami dan kami akan mendiagnosis kenderaan anda serta mengesyorkan servis yang tepat."}
            </p>
            <a 
