  ...
  return (
    <footer className={styles.footer} id="footer">
      <div className={`container ${styles.grid}`}>
        ...
        <div className={styles.brand}>
          ...
          <div className={styles.socials}>
            <a
              href="https://www.tiktok.com/@azamautohqkubangkerian"
              target="_blank"
            ...
            <a
              href="https://www.facebook.com/profile.php?id=100067465844743&mibextid=wwXIfr&rdid=IFOrgwh3AfQl54UB&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F17Dj5FvWJ9%2F%3Fmibextid%3DwwXIfr#"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.social}
              aria-label="Facebook"
        ...
        <div className={styles.col}>
          ...
          <ul className={styles.linkList}>
            ...
            <li>
              <Link href="/#cawangan" className={styles.footerLink}>
                {t('nav.branches')}
              </Link>
            </li>
            <li>
              <Link href="/#projek" className={styles.footerLink}>
                {t('nav.projek')}
              </Link>
            </li>
            <li>
          ...
          <div className={styles.contactList}>
            ...
            <div className={styles.contactItem} style={{ alignItems: 'center' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.2rem 0.4rem', alignItems: 'center' }}>
                <a href="tel:+60172525306" className={styles.footerLink}>+60 17-252 5306</a>
                <span style={{ opacity: 0.3, fontSize: '0.8rem' }}>|</span>
                <a href="tel:+60192752637" className={styles.footerLink}>+60 19-275 2637</a>
              </div>
            </div>
            <div className={styles.contactItem}>
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={styles.contactIcon}>
              ...
              <a href="mailto:adminhq@aabwsb.com" className={styles.footerLink}>adminhq@aabwsb.com</a>
            </div>
      ...
      <div className={styles.bottom}>
        <p>&copy; {year} AZAM AUTO BODYWORKS &amp; SERVICES (M) SDN BHD. {t('footer.rights')}</p>
      </div>
    </footer>
  );
}
